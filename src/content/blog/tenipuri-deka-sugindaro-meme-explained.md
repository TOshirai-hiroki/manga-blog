---
title: "Deka Sugindaro: When a Tennis Manga Produced a Building-Sized Player and Nobody Flinched"
description: "The Prince of Tennis evolved from a sports manga into something Japan calls ''teninu'' — not-tennis. The ''Too big'' meme is the three-word monument to that journey."
pubDate: '2026-04-01'
category: 'Manga Meme'
tags: ['The Prince of Tennis', 'Takeshi Konomi', 'meme', 'internet culture', 'sports manga', 'teninu']
affiliate: true
mangaAuthor: 'Takeshi Konomi'
mangaTitleJa: '新テニスの王子様'
amazonASIN: '1591164354'
amazonTitle: 'The Prince of Tennis, Vol. 1'
memeSource: 'New Prince of Tennis, Chapter 289'
memePublisher: 'Shueisha / VIZ Media'
memeCopyright: '© Takeshi Konomi / Shueisha'
---
...
1. **The target must be disproportionate, not merely large.** A big dog does not qualify. A dog the size of a municipal bus does.
2. **Your tone must remain flat.** The meme is an underreaction. If you sound impressed, you have failed.
3. **The ellipsis is mandatory.** Without the trailing silence, you are just complaining. With it, you are bearing witness.
4. **Context should involve genre violation.** The ideal deployment is when something has strayed so far from its original purpose that naming its category has become an act of fiction. A "quick meeting" that lasts three hours. A "small favor" that requires moving furniture. A tennis manga that has produced a man the size of the Bundestag.
