---
title: "Kuchiku Shite Yaru: When a Ten-Year-Old Declares Naval Warfare on His Feelings"
description: "Eren Yeager''s iconic vow from Attack on Titan uses military vocabulary no child should know. A Japanese reader dissects the linguistics of a boy who skipped grief and went straight to genocide."
pubDate: '2026-04-07'
category: 'Manga Meme'
tags: ['Attack on Titan', 'Hajime Isayama', 'meme', 'internet culture', 'Eren Yeager']
affiliate: true
mangaAuthor: 'Hajime Isayama'
mangaTitleJa: '進撃の巨人'
amazonASIN: '1612620248'
amazonTitle: 'Attack on Titan 1'
memeSource: 'Attack on Titan, Chapter 1'
memePublisher: 'Kodansha / Kodansha Comics'
memeCopyright: '© Hajime Isayama / Kodansha'
---
...
1. **The target must be disproportionately small relative to the vocabulary.** Declaring kuchiku on an actual army is not funny. Declaring kuchiku on a mosquito, a spreadsheet error, or the concept of humidity is.
2. **Commit fully to the register.** Half-measures are fatal. If you are going to quote Eren, you must deliver the line as though you genuinely intend to requisition a naval fleet to deal with your problem.
3. **The double exclamation marks are non-negotiable.** 「！！」 — two of them. One exclamation mark is emphasis. Two is a worldview.
